...
export type OpenIDChecks = OpenIDCallbackChecks | OAuthCallbackChecks
...
interface OpenIDAdvancedEndpointHandler<P extends UrlParams, C, R> {
...
export type OpenIDEndpointHandler<
  P extends UrlParams,
  C = any,
  R = any
> = OpenIDAdvancedEndpointHandler<P, C, R>

export type OpenIDAuthorizationEndpointHandler =
OpenIDEndpointHandler<AuthorizationParameters>

export type OpenIDTokenEndpointHandler = OpenIDEndpointHandler<
  UrlParams,
  {
    /**
...
export type OpenIDUserinfoEndpointHandler = OpenIDEndpointHandler<
  UrlParams,
  { tokens: TokenSet },
  Profile
>

export interface OpenIDConfig<P> extends CommonProviderOptions, PartialIssuer {
  /**
   ...
   */
  authorization?: string | OpenIDAuthorizationEndpointHandler
  token?: string | OpenIDTokenEndpointHandler
  userinfo?: string | OpenIDUserinfoEndpointHandler
  type: "openid"
  version?: string
...
export type OpenIDUserConfig<P> = Omit<
  Partial<OpenIDConfig<P>>,
  "options" | "type"
> &
  Required<Pick<OpenIDConfig<P>, "clientId" | "clientSecret">>

export type OpenIDProvider = (
  options: Partial<OpenIDConfig<any>>
) => OpenIDConfig<any>
